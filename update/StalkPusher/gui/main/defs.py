...
LBs = ['lb', 'lbs', 'lbf', 'pound', 'pounds', 'pound-force', 'pf', 'pf.']
Ns = ['newton', 'newtons', 'n','ns', 'n.']
DEGs = ['degrees', 'degree', 'deg', 'deg.', 'd', 'degs', 'ds']
RADs = ['radians', 'rads', 'radian', 'rad', 'rad.', 'r', 'rs', 'r.']
...
VERSION = 'version'
OPERATOR = 'operator'
LCA_WEIGHT = 'lcaWeight'#load cell assembly wieght
