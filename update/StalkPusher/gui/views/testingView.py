...
class TestingView(v.View):
    def __init__(self, app, prevView = None):
        ...
        self.postItems.append(vb.ViewBtn(app = self.app,
                                    pos = (self.cax-26*d.px, self.cay + 42 * d.py),
                                    dim = (22 * d.px, 12*d.py),
                                    label = 'Load',
                                    value = 'F',
...
#         print('###POST VECTOR ADDITION###')
        ...
        print('loadsY', self.loadsY)
        print('loads', self.loads)
        print('wAdjLoads', self.wAdjLoads)
...
#         self.madeUpData()
    ...
    def recalcWAdjLoads(self):
        ...
        if loadUnit.lower() in d.LBs:
            g = 1
            mass = mass * 0.00220462 #convert to lbm
        else:
            g = d.G_N
            mass = mass * 0.001 #convert to kg
        if self.drawPots:
...
#                             'Since the load cell assembly weight input is in grams, ',
#                             btnDefs = (
#                                 {'label': 'OK', 'id': 'yesBtn', 'funct': self.popMsg},
#                                 {},
#                                 {},
